...
echo "   Type: CNAME"
echo "   Name: trader"
echo "   Target: $(az network public-ip show --name ${APP_GATEWAY_NAME}-pip --resource-group $RESOURCE_GROUP --query dnsSettings.fqdn -o tsv)"
...
# Add custom domain to App Gateway (requires SSL certificate)
echo
echo -e "${YELLOW}⚠ SSL Certificate Required${NC}"
echo "Options:"
echo "1. Upload existing certificate"
echo "2. Create free App Service Managed Certificate"
...
# Step 18: Create Private Endpoint for Neon Database (if supported)
echo
echo "Step 18: Database Private Endpoint"
echo -e "${YELLOW}⚠ Note: Neon database private endpoints require Neon Business plan${NC}"
echo "Alternative: Use Neon IP allowlist to restrict to Azure outbound IPs"
echo
...
echo
echo "Next Steps:"
echo "1. Upload SSL certificate to Application Gateway"
echo "2. Configure health probes"
echo "3. Test application: https://trader.samarp.net"
echo "4. Review WAF logs for false positives"
echo "5. Set up monitoring alerts"
echo
echo "Resources:"
echo "  Application Gateway IP: $(az network public-ip show --name ${APP_GATEWAY_NAME}-pip --resource-group $RESOURCE_GROUP --query ipAddress -o tsv)"
